import { z } from 'zod';
import { TransactionCreateRequestSchema, TransactionStatus, PaymentType, CardType } from '../types.js';
...
export class TransactionTools {
    ...
    getTransactionsByPaymentTypeTool() {
        return {
    ...
    async executeTransactionTool(name, arguments_) {
        try {
            switch (name) {
    ...
    async handleGetTransactionsList(args) {
    ...
    async handleGetTransactionById(args) {
        const validatedArgs = validateInput(z.object({
            id: z.number()
        }), args);
    ...
    async handleUpdateTransactionStatus(args) {
        const validatedArgs = validateInput(z.object({
            id: z.number(),
    ...
    async handleGetAllCardTypes(args) {
        return await this.paymentService.getAllCardTypes();
    }
    async handleGetAllPaymentTypes(args) {
        return await this.paymentService.getAllPaymentTypes();
    }
}
//# sourceMappingURL=transactionTools.js.map